...
public class Rendering{
	...
	static boolean isRender, isRainbow;
	...
	public void onRender(TickEvent.RenderTickEvent e) {
		...
		if (Minecraft.getMinecraft().currentScreen == null && isRender) {
			...
			String[] showTexts = {String.format(Status_HUD.text, player.getName()), new TextComponentTranslation("yadokaris_shp.render.KillCountSword", (int)ChatEvent.killCountSword).getFormattedText(), new TextComponentTranslation("yadokaris_shp.render.KillCountBow", (int)ChatEvent.killCountBow).getFormattedText(), new TextComponentTranslation("yadokaris_shp.render.DeathCount", (int)ChatEvent.deathCount).getFormattedText(), new TextComponentTranslation("yadokaris_shp.render.Rate", rate).getFormattedText(), new TextComponentTranslation("yadokaris_shp.render.TotalRate", totalRate).getFormattedText(), new TextComponentTranslation("yadokaris_shp.render.NexusDamage", ChatEvent.nexusDamage).getUnformattedComponentText(), new TextComponentTranslation("yadokaris_shp.render.XP", ChatEvent.xp).getFormattedText(), new TextComponentTranslation("yadokaris_shp.render.TotalXP", (int)ChatEvent.totalXp).getFormattedText(), new TextComponentTranslation("yadokaris_shp.render.Rank", ChatEvent.rank).getUnformattedText(), new TextComponentTranslation("yadokaris_shp.render.RankPoint", ChatEvent.rankPoint).getUnformattedText(), new TextComponentTranslation("yadokaris_shp.render.CurrentJob", ChatEvent.currentJob).getFormattedText(), new TextComponentTranslation("yadokaris_shp.render.FPS", fps).getUnformattedText()};
